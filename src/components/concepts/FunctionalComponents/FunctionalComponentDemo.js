...
const HelloWorldFatArrow = () =>
    <div>
        <Card>
            <img width='100%' height='224px' src='https://i.ytimg.com/vi/_pfXEv9cFGE/maxresdefault.jpg' alt='card cap' />
            <CardBody>
                <CardTitle>Fat Arrow</CardTitle>
                <CardSubtitle>A JS Library</CardSubtitle>
                <CardText><pre>const HelloWorld = () [fat arrow symbol]</pre></CardText>
                <Button>Try This Out!</Button>
            </CardBody>
        </Card>
    </div>
